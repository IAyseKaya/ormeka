        ...
        <div className="about flex flex-col justify-center items-center">
            ...
            <div className='mt-20 mb-20 w-3/5'>
                <div className="px-4 sm:px-0">
                    <h1 className="text-3xl font-semibold leading-7 text-stone-900">Hakkımızda</h1>
                ...
                <div className="mt-6 border-t border-stone-100">
                    <dl className="divide-y divide-stone-100 ">
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold  font- leading-6 text-stone-900">Biz Kimiz</dt>
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="text-lg  font-bold  leading-6 text-stone-900">Vizyonumuz</dt>
                            <dd className="mt-1 text-lg  leading-6 text-stone-700 sm:col-span-2 sm:mt-0">Vizyonumuz, estetik ve fonksiyonel açıdan en iyi çözümleri sunarak, müşteri beklentilerinin ötesine geçmek, müşteri memnuniyetini sağlamak ve çalışanlarımızın tatmin ve memnuniyetini sağlayarak sektörde öncülük etmektir.
                                <br /></dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold  leading-6 text-stone-900">Misyonumuz</dt>
                            <dd className="mt-1 text-lg leading-6 text-stone-700 sm:col-span-2 sm:mt-0">Misyonumuz, yüksek standartlarda kaliteli hizmet sunarak müşteri memnuniyetini en üst düzeye çıkarmak, müşterilerimizin haklarına saygı göstermek ve çevreye karşı sorumluluklarımızı yerine getirmektir.
                                <br /></dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold  leading-6 text-stone-900">Firma Politikamız</dt>
                            <dd className="mt-1 text-lg leading-6 text-stone-700 sm:col-span-2 sm:mt-0"> Firma Politikamız, müşteri beklentilerini her defasında, zamanında ve tam olarak karşılamak; çevreye saygılı, estetik ve fonksiyonel açıdan müşteri memnuniyetini en üst düzeyde sağlayacak hizmeti sunmaktır.
                                <br />
